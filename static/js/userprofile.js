            ...
            if (contentText.message=='success'){
                ...
                xhr1.onload=function(){
                    if (this.status==200){
                        ...
                        document.getElementById("photo").src=document.getElementById("profile-title-image").src
                        document.getElementById("real-name").textContent = document.getElementById("id_real_name").value
                        document.getElementById("email").textContent = document.getElementById("id_email").value
                        document.getElementById("cellphone-number").textContent = document.getElementById("id_cellphone_number").value
                    }
                }
                xhr1.send()
