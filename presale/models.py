...
class Equipment(models.Model):
    ...
    category = models.ForeignKey(
        EquipCategory, null=True, blank=True, on_delete=models.SET_NULL
    )
...
class Inbound(models.Model):
    ...
    inbound_operator = models.ForeignKey(
        User,
        null=True,
        blank=True,
        on_delete=models.SET_NULL,
        related_name="devices_inbound",
    )
...
class Device(models.Model):
    ...
    maintainer = models.ForeignKey(
        ...
        blank=True,
        on_delete=models.SET_NULL,
        related_name="maintain_devices",
    )
    equipment = models.ForeignKey(
        Equipment, on_delete=models.CASCADE, related_name="devices"
    )
