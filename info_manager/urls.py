...
from .views import UserCreateView,UserListView,UserDeleteView,RoleListView,RoleUpdateView,EquipCategoryListView,EquipCategoryUpdateView,EquipCategoryDeleteView,EuipCategoryCreateView,WarehouseListView,WarehouseCreateView,WarehouseUpdateView,WarehouseDeleteView,PasswordResetView
...
urlpatterns=[
    ...
    path("category-list/<parent_id>/",EquipCategoryListView.as_view(),name="category-list"),
    path("category-update/<pk>/",EquipCategoryUpdateView.as_view(),name="category-update"),
    path("category-delete/<pk>/",EquipCategoryDeleteView.as_view(),name="category-delete"),
    ...
    path("warehouse-update/<pk>/",WarehouseUpdateView.as_view(),name="warehouse-update"),
