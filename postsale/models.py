...
class OutBound(models.Model):
    ...
    outbound_operator = models.ForeignKey(
        User,
        null=True,
        blank=True,
        on_delete=models.SET_NULL,
        related_name="devices_sold",
    )
...
class DeviceSold(models.Model):
    state_choices = [("good", "正常"), ("notuse", "未使用")]

    device = models.OneToOneField(
        Device, on_delete=models.CASCADE, related_name="device_sold"
    )
